...
Заверши попередні домашні завдання, пройди тести та переглянь теоретичні матеріали другого модулю.

Task 5

Підготуй запитання до попередніх тем, де є потреба детальнішого обговорення або практики з викладачем. Викладач збере запитання і виокремить найактуальніші для групи — їх ви опрацюєте разом у першу чергу.