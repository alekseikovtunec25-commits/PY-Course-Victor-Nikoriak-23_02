...
─────────────────────────────────────
    ...
    hello_project.asgi:application  → модуль:об'єкт (Django ASGI callable)
...
# hello_app (consumers, models тощо).
#
# ЧОМУ?
...
#          потім  from hello_project.routing import websocket_urlpatterns
