...
async def async_note_list(request):
    ...
    return await sync_to_async(render)(request, 'hello_app/note_list.html', {
        'notes': notes,
        'notebooks': notebooks,
        'tags': all_tags,
        'search': search,
...
async def async_note_detail(request, pk):
    ...
    return await sync_to_async(render)(request, 'hello_app/note_detail.html', {
        'note': note,
...
async def async_note_create(request):
    ...
    if request.method == 'POST':
        ...
        if await sync_to_async(form.is_valid)():
            ...
            return redirect('hello_app:async_note_detail', pk=note.pk)
    else:
        form = NoteForm(user=user)

    return await sync_to_async(render)(request, 'hello_app/note_form.html', {
        'form': form,
...
async def async_note_delete(request, pk):
    ...
    if note.user != user:
        ...
        return redirect('hello_app:async_note_list')
    ...
    return await sync_to_async(render)(request, 'hello_app/note_confirm_delete.html', {'note': note})
...
async def async_note_toggle_pin(request, pk):
    ...
    return redirect('hello_app:async_note_detail', pk=pk)
